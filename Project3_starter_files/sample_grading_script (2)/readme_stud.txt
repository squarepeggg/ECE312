...
As described in the project description, make your Project3.cpp.
Make a directory in kamek to run this script.  You may call it ~/EE312/Project3/GradingScript, for example.  Copy the sample_grading_script.zip to this folder, and unzip it using the unzip command.
Place Project3.cpp into the 'submissions' directory.
Then run ./grade.sh .
CAUTION: your submission file Project3.cpp will be deleted after grading, so keep a copy!
